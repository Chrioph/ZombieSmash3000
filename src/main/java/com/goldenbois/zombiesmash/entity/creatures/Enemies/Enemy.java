...
public abstract class Enemy extends Creature {
    ...
    protected void renderHealthbar(Graphics g) {
        ...
        g.fillRect((int) (x - handler.getGameCamera().getxOffset() + bounds.getWidth() - 5 * maxHealth - 4), (int) (y - handler.getGameCamera().getyOffset() - 15), 10 * maxHealth + 8, 10);
        g.fillRect((int) (x - handler.getGameCamera().getxOffset() + bounds.getWidth() - 5 * maxHealth), (int) (y - handler.getGameCamera().getyOffset() - 19), 10 * maxHealth, 18);
        g.setColor(Color.red);
        g.fillRect((int) (x - handler.getGameCamera().getxOffset() + bounds.getWidth() - 5 * maxHealth), (int) (y - handler.getGameCamera().getyOffset() - 15), 10 * maxHealth, 10);
        g.setColor(Color.green);
        g.fillRect((int) (x - handler.getGameCamera().getxOffset() + bounds.getWidth() - 5 * maxHealth), (int) (y - handler.getGameCamera().getyOffset() - 15), 10 * health, 10);
    ...
    protected void checkAttacks() {
        ar.setX((int) x + bounds.getX() - 6 - (int) handler.getGameCamera().getxOffset());
        ar.setY((int) y + bounds.getY() - 6 - (int) handler.getGameCamera().getyOffset());
        ar.setWidth(bounds.getWidth() + 12);
        ar.setHeight(bounds.getHeight() + 12);
     ...
     * @return
     */
    protected Image getCurrentAnimationFrame() {
