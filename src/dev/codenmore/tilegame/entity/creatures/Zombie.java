...
public class Zombie extends Creature {
	...
	public void die() {
		...
		if(arr[4]==7)
			handler.getWorld().getItemManager().addItem(Item.healthPlusItem.createNew((int) (x + Utils.generateRandomInt(200)-100),(int) ( y + Utils.generateRandomInt(200)-100 + bounds.height+100)));
	}
