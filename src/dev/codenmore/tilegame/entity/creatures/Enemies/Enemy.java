...
public abstract class Enemy extends Creature {
	...
	private void spawnItems() {
		...
		if (arr[0]==3||arr[0]==5||arr[0]==6||arr[0]==15)
			handler.getWorld().getItemManager().addItem(Item.swordItem.createNew(1), (int)x,(int)y);
				
		if(arr[1]==3||arr[1]==5||arr[1]==6||arr[1]==2||arr[1]==15||arr[1]==16||arr[1]==12)
			handler.getWorld().getItemManager().addItem(Item.heartItem.createNew(1), (int)x,(int)y);
				
		if(arr[2]==3||arr[2]==5||arr[2]==4||arr[2]==8||arr[2]==6||arr[2]==7||arr[2]==13||arr[2]==15||arr[2]==14||arr[2]==10||arr[2]==16||arr[2]==9)
			handler.getWorld().getItemManager().addItem(Item.arrowItem.createNew(1), (int)x,(int)y);
		if(arr[5]==3||arr[5]==5||arr[5]==4||arr[5]==13||arr[5]==15||arr[5]==14)
			handler.getWorld().getItemManager().addItem(Item.arrowItem.createNew(1),(int)x,(int)y);
				
		if(arr[3]==3||arr[3]==5||arr[3]==1||arr[3]==7||arr[3]==13)
			handler.getWorld().getItemManager().addItem(Item.armorItem.createNew(1), (int)x,(int)y);
				
		if(arr[4]==7||arr[4]==13)
			handler.getWorld().getItemManager().addItem(Item.healthPlusItem.createNew(1), (int)x,(int)y);
				
		if(arr[5]==3||arr[5]==12)
			handler.getWorld().getItemManager().addItem(Item.bowItem.createNew(1), (int)x,(int)y);
	}
